...
### Tier 1: [이름] (예: Starter)
- **가격**: ₩XXX,XXX/월 (100인 기준) 또는 ₩X,XXX/인/월
- **타겟**: [스타트업/중소기업/특정 규모]
- **포함 기능**:
  - 기능 1
  - 기능 2
...
### Tier 2: [이름] (예: Professional) ⭐ 추천
- **가격**: ₩XXX,XXX/월 (100인 기준)
- **타겟**: [성장하는 기업/중견기업]
- **포함 기능**:
  - Tier 1의 모든 기능
  - 추가 기능 1
...
- **지원**:
  - 우선 이메일 지원
  - 월 1회 상담
- **가격 대비 가치**: [왜 이 Tier가 best value인지]

### Tier 3: [이름] (예: Enterprise)
- **가격**: 맞춤 견적 (또는 ₩XXX,XXX/월)
- **타겟**: [대기업/특수 요구사항]
- **포함 기능**:
  - 모든 기능
  - 커스터마이징
